...
# Define app layout
app = dash.Dash(__name__, routes_pathname_prefix='/Monitoraggio_Analisi_Performance/IIS/', title ='Tool IIS', external_stylesheets=[dbc.themes.BOOTSTRAP])
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.H2('Engineered by Monitoraggio & Analisi Prodotti di Investimento', className="h2")
    ], className="row text-center header"),
    ...
    html.Div([
        html.Table([
            ...
            html.Thead([
                html.Tr([
                    html.Th('Data Primo Versamento (Fine Mese)', className=""),
                    html.Th('Importo (Min. €30.000)', className=""),
                    html.Th('Durata', className=""),
                    html.Th('Importo Rata Totale', className=""),
            ...
            html.Tbody([
                html.Tr([
                    ...
                    html.Td(html.Div(id='installment-amount', className=""), className="")
            ...
            html.Thead([
                html.Tr([
                    html.Th('Comparto', className=""),
                    html.Th('Ripartizione (0% - 100%)', className=""),
                    html.Th('Soglia Automatic Step-Out', className=""),
                    html.Th('Importo Rata', className="")
                ], className="table-primary"),
            ]),
            ...
            html.Tbody([
                html.Tr([
                    html.Td(dcc.Dropdown(id='fondo1', options=[{'label': fondo, 'value': fondo} for fondo in nomi]),
                            className=""),

                    html.Td(dcc.Input(id='input1', type='number', min=0), className=""),
                    html.Td(dcc.Dropdown(id='step_out1', options=[
                        {'label': '10%', 'value': '10%'},
                        {'label': '20%', 'value': '20%'}]), className=""),
                    html.Td(id='rata1', className="")

                ], className=""),
                html.Tr([
                    html.Td(dcc.Dropdown(id='fondo2', options=[{'label': fondo, 'value': fondo} for fondo in nomi]),
                            className=""),
                    html.Td(dcc.Input(id='input2', type='number', min=0), className=""),
                ...
                html.Tr([
                    html.Td(dcc.Dropdown(id='fondo3', options=[{'label': fondo, 'value': fondo} for fondo in nomi]),
                            className=""),
                    html.Td(dcc.Input(id='input3', type='number', min=0), className=""),
                    html.Td(dcc.Dropdown(id='step_out3', options=[
                        {'label': '10%', 'value': '10%'},
                        {'label': '20%', 'value': '20%'}]), className=""),
                    html.Td(id='rata3', className="")
    ...
    #messaggio somma 100
    html.Div(id='output', className=""),
    


    html.Div([
    dcc.Graph(id='grafico_iis', className="", config={'displayModeBar': False}),
    ], className="row mt-5"),



    html.Div([
        dcc.Graph(id='istogramma', className="", config={'displayModeBar': False})
    ], className="row"),
    ...
    html.Div([
        html.H2("Prezzo vs Prezzo Medio di Carico vs Prezzo Medio")
    ...
    html.Div([
        ...
        html.Div([
            dcc.Graph(id='pmc1', config={'displayModeBar': False}),
        ], className="col-4"),

        html.Div([
            dcc.Graph(id='pmc2',  config={'displayModeBar': False}),
        ], className="col-4"),


        html.Div([
            dcc.Graph(id='pmc3', config={'displayModeBar': False}),
        ], className="col-4"),
